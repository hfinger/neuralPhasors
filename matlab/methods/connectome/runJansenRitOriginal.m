function [ xColl, driverColl, xCollExtended ] = runJansenRitOriginal( StartStates,Drivers,DrivFreqs,DrivPO,DrivStart,DrivDur,C,D,k,v,tMax,dt,initSampRem,nVar,nMu,rAvg,netInp,subInp,sampling,verbose,JRParams )
