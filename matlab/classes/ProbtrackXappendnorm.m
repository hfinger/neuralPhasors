classdef ProbtrackXappendnorm < Gridjob
  ...
  methods
    ...
    function this = ProbtrackXappendnorm(varargin)
      ...
      this.params.ProbtrackXappendnorm.split = num2cell(1:1);
      this.params.ProbtrackXappendnorm.numberPerSplit = 1000;
      this.params.ProbtrackXappendnorm.numberRegions = 52442;
      this.params.ProbtrackXappendnorm.divisions = 53;
