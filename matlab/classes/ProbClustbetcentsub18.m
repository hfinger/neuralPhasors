classdef ProbClustbetcentsub18 < Gridjob
    ...
    methods
        ...
        function this = ProbClustbetcentsub18(varargin)
            ...
            this.params.ProbClustbetcentsub18.split = num2cell(1:1276);
            %%%% END EDIT HERE:                                          %%%%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function run(this)
            ...
            waitForServer();
            subjNum = ceil(this.params.ProbClustbetcentsub18.split/58);
            rangeflag = mod(this.params.ProbClustbetcentsub18.split,58);
            if rangeflag == 0
                rangeflag = 58;
            end
            if rangeflag == 1
                ...
                for clusterNum = clustRange
                    ...
                    if pass
                        if exist([clusterPath num2str(subjNum)], 'dir')
                            disp([num2str(subjNum) clusterType num2str(clusterNum)]);
                            ...
                            save([newOutputPath 'betCentr' num2str(clusterNum) '.mat'], 'betCentr');
