classdef Probtrackforolddata < Gridjob
  ...
  methods
    ...
    function this = Probtrackforolddata(varargin)
      ...
      this.params.Probtrackforolddata.split = num2cell([46 75]);
      this.params.Probtrackforolddata.splitPerSubject = 100;
      this.params.Probtrackforolddata.subjectId = num2cell(1);
    ...
    function startJob(this)
      ...
      disp('Probtrackforolddata:this excecutes before the parallel job is started');
...
%       voxelcount = load('/net/store/nbp/projects/phasesim/workdir/Arushi/20160210Allsubjecttracking/voxelcount_FA_thr_012.mat');
      ...
      subjectId = this.params.Probtrackforolddata.subjectId;
      if subjectId < 10;
      ...
      compl_fs_mask = load_untouch_nii([datapaths.databases '/SC_Bastian/mosaic_2015_02_18/compl_fs_mask.nii']);
      voxelIndexInImg = find(compl_fs_mask.img);
      %change end for all subject tracking 20150727
      
      voxelCount = size(voxelIndexInImg,1);      
      splitPerSubject = this.params.Probtrackforolddata.splitPerSubject;
      
      currentSplit = this.params.Probtrackforolddata.split;
...
%         numberVoxThisSplit = voxelCount - numberVoxPerSplit * (1 - splitPerSubject);
      ...
      FAmask = load_untouch_nii([datapaths.databases '/SC_Bastian/mosaic_2015_02_18/ca01_1_dti/ca01_1_FA.nii.gz']);
