...
%       status = rmdir(userfolder);
        ...
        connmat = load([datapaths.workdir '/Arushi/20150422_ProbtrackX/connmat' ...
                        num2str(this.params.ProbtrackXdivide.split) '.mat']);
        waytotal = load([datapaths.workdir '/Arushi/20150422_ProbtrackX/waytotal' ...
                         num2str(this.params.ProbtrackXdivide.split) '.mat']);
        connmat = bsxfun(@ldivide, connmat, waytotal);
        save([datapaths.workdir '/Arushi/20150422_ProbtrackX/connmatdiv' ...
              num2str(this.params.ProbtrackXdivide.split) '.mat'], 'connmat');
          clear connmat;
          clear waytotal;
