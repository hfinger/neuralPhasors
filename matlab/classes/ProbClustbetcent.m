classdef ProbClustbetcent < Gridjob
    ...
    methods
        ...
        function this = ProbClustbetcent(varargin)
            ...
            this.params.ProbClustbetcent.split = num2cell(693);
            %%%% END EDIT HERE:                                          %%%%
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function run(this)
            ...
            waitForServer();
            subjNum = ceil(this.params.ProbClustbetcent.split/58);
            rangeflag = mod(this.params.ProbClustbetcent.split,58);
            if rangeflag == 0
                rangeflag = 58;
            end
            if rangeflag == 1
