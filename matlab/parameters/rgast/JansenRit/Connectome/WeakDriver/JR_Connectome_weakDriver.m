...
params.Gridjob.jobname = 'JR_Connectome_weakDriver'; % name of the grid job
...
params.JansenRitConnectome.lesionNode = 0; % index of node to lesion in network
...
params.JansenRitConnectome.drivScale = 10; % driver strength [mV]
