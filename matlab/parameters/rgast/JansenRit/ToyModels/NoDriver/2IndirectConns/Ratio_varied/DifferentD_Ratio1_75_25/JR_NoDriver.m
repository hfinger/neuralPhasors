...
% delay matrix
d14_1 = 100; % distance between nodes at the ends of chain for path 1
d14_2 = 50; % distance between nodes at the ends of chain for path 2
d_ratio1 = [0.:0.01:1]; % relative position of internode on path 1
d_ratio2 = 0.75; % relative position of internode on path 2

for d=1:length(d_ratio1)
    D = zeros(4);
    D(1,2) = d_ratio1(d)*d14_1;
    D(2,4) = (1-d_ratio1(d))*d14_1;
    D(1,3) = d_ratio2*d14_2;
    D(3,4) = (1-d_ratio2)*d14_2;
    D(1,4) = d14_2;
    D = D + D';
    Delays{d} = D;
end
...
params.JansenRitConnectome.drivPos = [1,4]; % indices of network nodes to be driven
