...
params.Gridjob.jobname = 'JR_NoDriver_bidirect';
...
params.JansenRitConnectome.k = 60; %global connection strength scaling
params.JansenRitConnectome.v = 4.8; % velocity [m/s]
