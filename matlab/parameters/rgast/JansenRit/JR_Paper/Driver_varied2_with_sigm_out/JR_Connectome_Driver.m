...
params.JansenRitConnectomePaper.drivPos = 3; %num2cell(idx); % indices of network nodes to be driven
params.JansenRitConnectomePaper.drivScale = 2; %num2cell([1,2,4,8,16,32]); % driver strength [mV]
params.JansenRitConnectomePaper.drivPO = 0; % phase offset of drivers
params.JansenRitConnectomePaper.drivFreq = {9, 10}; %num2cell([8:0.5:14]); % frequency of driver [Hz]
