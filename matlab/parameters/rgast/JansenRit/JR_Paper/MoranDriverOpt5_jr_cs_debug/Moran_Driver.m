...
params.JansenRitConnectomePaper.xCollExtended = true;
params.JansenRitConnectomePaper.xCollExtendedIdxs = 1:12;
...
params.JansenRitConnectomePaper.drivScale = 1; %num2cell([0.25,0.5,1,2,4]); % driver strength [mV]
params.JansenRitConnectomePaper.drivPO = 0; % phase offset of drivers
params.JansenRitConnectomePaper.drivFreq = 15; %num2cell([5:1:18]); % frequency of driver [Hz]
