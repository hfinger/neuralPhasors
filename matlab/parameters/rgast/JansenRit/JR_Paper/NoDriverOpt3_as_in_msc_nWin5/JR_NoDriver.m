...
params.JansenRitConnectomePaper.k = num2cell(30*ones(1,17)); %global connection strength scaling
...
params.JansenRitConnectomePaper.nWindows = 5; %number of timewindows over which to calculate mean coherence
...
params.JansenRitConnectomePaper.Hi = 20e-3; % Average synaptic gain for inhibitory synapses [V]
