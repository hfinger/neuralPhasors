...
params.JansenRitConnectomePaper.k = 4; %num2cell([4, 6, 8]); %num2cell([3, 10]); %30; %num2cell(round(22:2:34)); %global connection strength scaling
params.JansenRitConnectomePaper.v = num2cell(round(1.6:0.4:4.8)); %3.2; % velocity [m/s]
