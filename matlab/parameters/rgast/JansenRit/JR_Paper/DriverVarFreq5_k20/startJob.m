...
params.JansenRitConnectomePaper.drivScale = num2cell(2.^(-6:0.5:3)); % driver strength [mV]
params.JansenRitConnectomePaper.drivPO = 0; % phase offset of drivers
params.JansenRitConnectomePaper.drivFreq = num2cell([5:0.5:22]); % frequency of driver [Hz]
