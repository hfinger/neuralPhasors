...
params.JansenRitConnectomePaper.k = num2cell([1, 3, 10, 30, 100, 300, 1000, 3000]); %30; %num2cell(round(22:2:34)); %global connection strength scaling
...
params.JansenRitConnectomePaper.use_out_psp = true;
