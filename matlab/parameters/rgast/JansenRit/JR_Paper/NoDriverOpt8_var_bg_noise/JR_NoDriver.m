...
params.JansenRitConnectomePaper.noiseVar = num2cell(round(14:2:30)); %22; % variance of noise used to drive neural masses (22 was mentioned in msc thesis)
params.JansenRitConnectomePaper.noiseMu = 140; %220; % mean of noise used to drive neural masses (220 was mentioned in msc thesis)
