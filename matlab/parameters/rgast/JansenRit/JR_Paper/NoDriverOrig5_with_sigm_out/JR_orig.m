...
params.JansenRitConnectomePaper.k = num2cell([4, 6, 8]); %num2cell([3, 10]); %30; %num2cell(round(22:2:34)); %global connection strength scaling
params.JansenRitConnectomePaper.v = 3.2; %num2cell(round(1.6:0.4:4.8)); %3.2; % velocity [m/s]
...
params.JansenRitConnectomePaper.nWindows = 4; %number of timewindows over which to calculate mean coherence
