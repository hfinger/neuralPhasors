...
params.JansenRitConnectomePaper.k = num2cell(3:0.5:5); %num2cell([3, 10]); %30; %num2cell(round(22:2:34)); %global connection strength scaling
params.JansenRitConnectomePaper.v = 2.6; %num2cell(round(2.4:0.1:3.2)); %3.2; % velocity [m/s]
