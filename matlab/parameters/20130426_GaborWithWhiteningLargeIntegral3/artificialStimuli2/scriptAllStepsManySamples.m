...
params.LoadImage.filepath = {...
  '/net/store/nbp/phasesim/databases/ArtificialStimuli/alignedBarsWithBgNoise.png',...
  '/net/store/nbp/phasesim/databases/ArtificialStimuli/circleWithBgNoise.png',...
  '/net/store/nbp/phasesim/databases/ArtificialStimuli/noiseStd0p1plusLines.png'};
