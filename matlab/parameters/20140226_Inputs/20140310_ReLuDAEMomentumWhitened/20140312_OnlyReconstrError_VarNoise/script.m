...
params.Autoencoder.inActFolder = '../../labelMeWhiteZtransformed';
...
params.Autoencoder.initWGaussian = false; % CHANGED!!!!
...
params.Autoencoder.gamma = {0.3, 1};        % weight of topographic sparsity penalty term
...
params.minFuncGrad.learnrate = {3e-5, 1e-4};
