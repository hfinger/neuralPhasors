...
params.Autoencoder.inActFolder = '../../labelMeZtransformed';
...
params.Autoencoder.inSamplesDims = [60 60 3 1100]; % [x,y,#features,#samples]
...
params.Autoencoder.gamma = 0.3;        % weight of topographic sparsity penalty term
params.Autoencoder.gammaPvalue = 1;
params.Autoencoder.maskingNoiseFraction = 0;        % fraction of inputs to set to 0
params.Autoencoder.gaussianNoiseSigmaInput = 1.5;

params.Autoencoder.numberOfPatchReloads = 10;
...
params.Autoencoder.validationDoOptout = false;
...
params.minFuncGrad.learnrate = {3e-5, 1e-4, 3e-4}; %!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
