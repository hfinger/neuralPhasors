...
params.Gridjob.jobname = 'RectLinBiDAE100';
...
params.Autoencoder.outWeightsFolder = 'RectLinBiDAE100';
...
params.Autoencoder.useNoActFcn = true; %instead of sigmoid
params.Autoencoder.useSoftmax = false;
params.Autoencoder.useNormMean = false;
params.Autoencoder.useRectifiedLinear = true;

params.Autoencoder.hiddenLinearBinaryThresholdUnits = true;
params.Autoencoder.hiddenSigmoidBinaryThresholdUnits = false;

params.Autoencoder.saveinterval = Inf;
params.Autoencoder.saveintervalLog = 100;
params.Autoencoder.saveintervalpng = 500;
...
params.Autoencoder.lambda = {0.01, 0.035, 0.1};   % weight of L2-decay parameter
params.Autoencoder.lambdaL1 = 0;    % weight of L1-decay parameter
params.Autoencoder.scaleLambdaL1WithDistExponent = 0;
params.Autoencoder.beta = {0.1, 1};         % weight of sparsity penalty term
