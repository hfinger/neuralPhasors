...
params.Gridjob.runLocal = false;
params.Gridjob.requiremf = 12000;
params.Gridjob.jobname = 'layer1PhaseFeatMoreRad';
...
params.PhaseFeat.outPhaseFeatFolder = 'layer1PhaseFeatMoreRad';
params.PhaseFeat.filtRadius = {1,2,3,5,7,10,14,20,28};
...
% params.Gridjob.jobname = 'layer1FixationEvalMoreRadMoreRad';
% params.EvaluateFixations.inPhaseFeatFolder = {'layer1PhaseFeat/1','layer1PhaseFeat/2','layer1PhaseFeat/3','layer1PhaseFeat/4','layer1PhaseFeat/5','layer1PhaseFeat/6','layer1PhaseFeat/7','layer1PhaseFeat/8','layer1PhaseFeat/9'};
...
% params.EvaluateFixations.inFixationOffsetY = 60;
% params.EvaluateFixations.outFolder = 'layer1FixationEvalMoreRad';
% paramsAll{7} = params;
% 
% clear params;
% allfixmat = load('/net/store/nbp/PhaseFeat/labelme/allfixmat.mat');
% params.Gridjob.runLocal = false;
% params.Gridjob.requiremf = 5000;
% params.Gridjob.jobname = 'layer1FixationEvalNonmatchMoreRad';
...
% params.EvaluateFixations.outFolder = 'layer1FixationEvalNonmatchMoreRad';
% paramsAll{8} = params;
