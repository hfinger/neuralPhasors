...
params.LoadImage.filepath = cellfun(@(x) num2str(x, '/net/store/nbp/phasesim/databases/PhaseFeat/labelme/image_%02d.jpg'), num2cell(1:600),'UniformOutput',false);
...
params.ApplyWeights.fileid = 1:600;
...
params.PhaseSimulation.inFileid = num2cell(1:600);
...
clear params;
gridjobs = Gridjob(paramsAll(4:6));
start(gridjobs);
