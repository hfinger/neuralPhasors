...
params.Gridjob.runLocal = false;
params.Gridjob.requiremf = 3000;
params.Gridjob.jobname = 'layer1EvalHueAllSegments';
...
params.SegmentationEval.outSegEvalFolder = 'layer1EvalHueAllSegments';
params.SegmentationEval.catName = '05june05_static_street_boston';
params.SegmentationEval.fileid = [1:185];
params.SegmentationEval.minPixelPerSeg = 0;
