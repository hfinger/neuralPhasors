...
params.Gridjob.jobname = 'DAE100VarLambdaVarBeta';

params.Autoencoder.inActFolder = 'labelMeWhite';
params.Autoencoder.inActFilenames = 'act.*.mat';
params.Autoencoder.outWeightsFolder = 'DAE100VarLambdaVarBetaWeights';
...
params.Autoencoder.lambda = {3e-4,1e-3,3e-3};    % weight of L2-decay parameter
params.Autoencoder.lambdaL1 = 0;    % weight of L1-decay parameter
params.Autoencoder.scaleLambdaL1WithDistExponent = 0;
params.Autoencoder.beta = {0.1,0.3,1};         % weight of sparsity penalty term
