...
params.Gridjob.jobname = 'DAE100SoftmaxSubsamplingSigm';

params.Autoencoder.inActFolder = 'labelMeWhite';
params.Autoencoder.inActFilenames = 'act.*.mat';
params.Autoencoder.outWeightsFolder = 'DAE100SoftmaxSubsamplingSigm';
...
params.Autoencoder.patchDimBackward = {2, 4};
