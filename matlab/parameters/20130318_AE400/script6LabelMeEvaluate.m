...
params.Gridjob.jobname = 'lMLayer1EvalHue';
...
params.SegmentationEval.outSegEvalFolder = 'labelMeLayer1SegEvalHue';
...
params.SegmentationEval.time=0;%{0,10,20,30};
...
params.SegmentationEval.useHueInsteadPhase = true;%false;
