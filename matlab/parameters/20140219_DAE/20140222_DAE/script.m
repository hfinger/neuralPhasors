...
params.Autoencoder.inActFolder = {'../../20131217_ReLuDAE/20140204_InputZtrafo/labelMeZtransformed', '../../20131217_ReLuDAE/20131220_MoreImages/labelMeWhite'};
params.Autoencoder.inActFilenames = 'act.*.mat';
params.Autoencoder.outWeightsFolder = 'DAE100';
...
params.Autoencoder.lambda = {0.3, 1};    % weight of L2-decay parameter
...
params.Autoencoder.gaussianNoiseSigmaInput = {0.3, 0.75};
