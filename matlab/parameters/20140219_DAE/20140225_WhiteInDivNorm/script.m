...
params.Gridjob.jobname = 'wDAE100';
...
params.Autoencoder.outWeightsFolder = 'wDAE100';
...
params.Autoencoder.gammaPvalue = 0;
params.Autoencoder.maskingNoiseFraction = 0;        % fraction of inputs to set to 0
params.Autoencoder.gaussianNoiseSigmaInput = {0.1, 0.5};
