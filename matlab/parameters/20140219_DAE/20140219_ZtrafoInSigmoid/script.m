...
params.Gridjob.jobname = 'zDAE100Sig';
params.Gridjob.initRandStreamWithSeed = 12345;

params.Autoencoder.inActFolder = '../../20131217_ReLuDAE/20140204_InputZtrafo/labelMeZtransformed';
params.Autoencoder.inActFilenames = 'act.*.mat';
params.Autoencoder.outWeightsFolder = 'zDAE100Sig';
...
params.Autoencoder.lambda = 0.3;    % weight of L2-decay parameter
