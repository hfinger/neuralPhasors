...
params.Autoencoder.alpha = 0.01;        % weight of Autoencoder
params.Autoencoder.lambda = {0.003, 0.01};    % weight of L2-decay parameter
params.Autoencoder.lambdaL1 = 0;    % weight of L1-decay parameter
params.Autoencoder.scaleLambdaL1WithDistExponent = 0;
params.Autoencoder.beta = {0.9, 3};         % weight of sparsity penalty term
...
params.Autoencoder.maskingNoiseFractionHidden = 0.5;
...
params.Autoencoder.topoPeriodicBoundary = [true];
