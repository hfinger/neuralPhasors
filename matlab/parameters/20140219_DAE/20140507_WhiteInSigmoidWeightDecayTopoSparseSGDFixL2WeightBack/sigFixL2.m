...
params.Gridjob.jobname = 'sigFixL2';
...
params.Autoencoder.outWeightsFolder = 'sigFixL2';
...
params.Autoencoder.maskingNoiseFractionHidden = {0, 0.5};
...
params.Autoencoder.validationInterval = 100;
...
params.minFuncGrad.learnrate = {1e-5, 3e-5};
