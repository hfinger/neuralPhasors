...
% INIT PARAMS:
params.Autoencoder.inSamplesDims = {[60 60 3 2000],[60 60 3 100],[60 60 3 500],[60 60 3 500],[60 60 3 500],[60 60 3 500],[60 60 3 500]}; % [x,y,#features,#samples]
...
params.Autoencoder.maskingNoiseFractionHidden = {0.5, 0.5, 0.5, 0.5, 0, 0.5, 0.5};        % fraction of inputs to set to 0
...
params.Autoencoder.topoNghFcn = {[],[],[],[],[],@(x) exp(-((1:x)-x/2).^2/4),[]};
params.Autoencoder.topoNgh = {[3 3],[3 3],[3 3],[3 3],[3 3],[7 7],[3 3]};
...
params.Autoencoder.lambda = {1,1,1,0,1,1,1};%0.1;    % weight of L2-decay parameter
params.Autoencoder.lambdaBackScale = {1, 1, 0, 1, 1, 1, 1};    % weight of L2-decay parameter scaling for backward conenctions
...
params.Autoencoder.fixL2WeightBack = {false, false, true, false, false, false, false}; %if true, remember to also set both backScale to 0
...
params.Autoencoder.numberOfPatchReloads = {50, 1000, 200, 200, 200, 200, 400};
...
params.minFunc.maxIter = {20,20,20,20,20,20,10};
