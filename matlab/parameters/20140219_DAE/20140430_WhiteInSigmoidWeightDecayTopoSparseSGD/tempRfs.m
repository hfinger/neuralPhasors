...
params.ApplyWeights.inActFolder = '../../20131217_ReLuDAE/20131220_MoreImages/labelMeWhite/05june05_static_street_boston/p1010736.jpg';
params.ApplyWeights.inActFilenames = 'act.*.mat';
params.ApplyWeights.fileid = 1;
params.ApplyWeights.outActFolder = 'rfsWithoutActFcn';
params.ApplyWeights.weightsFile = cellfun(@(x) ['temp_wDAE100Sig/' num2str(x) '/forwConnIter490.mat'],num2cell(1:3),'UniformOutput',false);
