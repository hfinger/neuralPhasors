...
params.Gridjob.jobname = 'layer1ConnAbsCorr0p1';
params.Gridjob.requiremf = 3000;
params.ProbabilisticConn.inCorrFile = 'layer1Cov/patchCorr.mat';
params.ProbabilisticConn.outWeightsFolder = 'layer1ConnAbsCorr0p1';
...
params.ProbabilisticConn.FDRalpha = [];
...
params.Gridjob.runLocal = false;
params.Gridjob.requiremf = 3000;
params.Gridjob.jobname = 'layer1PhaseAbsCorr0p1';
...
params.PhaseSimulation.inConnFilename = 'layer1ConnAbsCorr0p1/weights.mat';
params.PhaseSimulation.inPhaseFilename = [];
params.PhaseSimulation.outPhaseFolder = 'layer1PhaseAbsCorr0p1';
