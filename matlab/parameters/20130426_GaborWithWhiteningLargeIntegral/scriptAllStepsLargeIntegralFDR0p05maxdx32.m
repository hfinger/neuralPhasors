...
clear params;
params.Gridjob.runLocal = false;
params.Gridjob.jobname = 'layer1Covmaxdx32';
params.Gridjob.requiremf = 3000;
...
params.FeatureCovariance.outCovFolder = 'layer1Covmaxdx32';
...
clear params;
params.Gridjob.runLocal = false;
params.Gridjob.jobname = 'layer1ConnFDR0p05maxdx32';
params.Gridjob.requiremf = 3000;
params.ProbabilisticConn.inCorrFile = 'layer1Covmaxdx32/patchCorr.mat';
params.ProbabilisticConn.outWeightsFolder = 'layer1ConnFDR0p05maxdx32';
...
params.Gridjob.runLocal = false;
params.Gridjob.requiremf = 3000;
params.Gridjob.jobname = 'layer1PhaseFDR0p05maxdx32';
...
params.PhaseSimulation.inConnFilename = 'layer1ConnFDR0p05maxdx32/weights.mat';
params.PhaseSimulation.inPhaseFilename = [];
params.PhaseSimulation.outPhaseFolder = 'layer1PhaseFDR0p05maxdx32';
