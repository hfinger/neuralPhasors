...
params.Gridjob.jobname = 'AE100subsVar';
params.Gridjob.wc_host = [];

params.Autoencoder.inActFolder = 'labelMeWhite';
params.Autoencoder.inActFilenames = 'act.*.mat';
params.Autoencoder.outWeightsFolder = 'AE100subsVarWeights';
...
params.Autoencoder.lambda = {0.0003,0.001,0.003};    % weight of L2-decay parameter
