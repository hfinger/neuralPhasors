...
params.Gridjob.jobname = 'AE100subsVarManySamplesFullbatch';
params.Gridjob.wc_host = [];

params.Autoencoder.inActFolder = 'labelMeWhite';
params.Autoencoder.inActFilenames = 'act.*.mat';
params.Autoencoder.outWeightsFolder = 'AE100subsVarManySamplesFullbatchWeights';
...
params.Autoencoder.batchsize = 2500; %[] means full batch
