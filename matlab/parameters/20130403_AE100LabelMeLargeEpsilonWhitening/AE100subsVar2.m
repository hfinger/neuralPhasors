...
params.Gridjob.jobname = 'AE100subsVar2';
params.Gridjob.wc_host = [];

params.Autoencoder.inActFolder = 'labelMeWhite';
params.Autoencoder.inActFilenames = 'act.*.mat';
params.Autoencoder.outWeightsFolder = 'AE100subsVar2Weights';
...
params.Autoencoder.lambda = 0.01;    % weight of L2-decay parameter
