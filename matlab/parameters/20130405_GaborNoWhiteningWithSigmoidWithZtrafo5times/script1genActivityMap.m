...
conn.inputSubtract(1,1,:) = [0.4255, 0.4409, 0.4324];
conn.inputScaling = zeros(1,1,3);
conn.inputScaling(1,1,:) = [1/0.2465, 1/0.2432, 1/0.2563];
...
params.ApplyWeights.inActFolder = 'labelMeActLayer1noRectify';
params.ApplyWeights.inActFilenames = 'act.*.mat';
params.ApplyWeights.outActFolder = 'labelMeActLayer1';
params.ApplyWeights.weightsFile = [];%'forwConn.mat';
