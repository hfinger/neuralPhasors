...
params.Gridjob.walltime = '00:39:59';
...
params.JansenRitConnectomePaper.drivScale = num2cell(2.^(-7:0.5:1)); % driver strength [mV]
params.JansenRitConnectomePaper.drivPO = 0; % phase offset of drivers
params.JansenRitConnectomePaper.drivFreq = num2cell([4:26]); % frequency of driver [Hz]
