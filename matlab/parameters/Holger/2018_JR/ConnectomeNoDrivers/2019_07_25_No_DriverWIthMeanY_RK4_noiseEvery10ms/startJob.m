...
params.JansenRitConnectomePaper.tMax = 30; %max simulation time [seconds]
params.JansenRitConnectomePaper.sampling = {1, 2, 4, 10, 20, 40, 100}; % sampling every x steps
params.JansenRitConnectomePaper.sampleNoiseEvery = params.JansenRitConnectomePaper.sampling; % sampling every x steps
params.JansenRitConnectomePaper.dt = num2cell(cellfun(@(x) 0.01/x, params.JansenRitConnectomePaper.sampling)); % simulation step size [seconds]
...
params.JansenRitConnectomePaper.drivDur = 60; % duration of driver [s]
