...
params.JansenRitConnectomePaper.tMax = 20; %max simulation time [seconds]
params.JansenRitConnectomePaper.dt = {0.0005, 0.0001, 0.00005, 0.00001}; % simulation step size [seconds]
params.JansenRitConnectomePaper.sampling = {2, 10, 20, 100}; % sampling every x steps
params.JansenRitConnectomePaper.sampleNoiseEvery = {1, 5, 10, 50}; % sampling every x steps
...
params.JansenRitConnectomePaper.initSampRem = 0; %initial interval to remove [seconds]
