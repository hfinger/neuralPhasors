...
params.JansenRitConnectomePaper.dt = {0.0005, 0.0001, 0.00005}; % simulation step size [seconds]
params.JansenRitConnectomePaper.sampling = {2, 10, 20}; % sampling every x steps
params.JansenRitConnectomePaper.sampleNoiseEvery = {1, 5, 10}; % sampling every x steps
