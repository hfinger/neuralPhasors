...
params.JansenRitConnectomePaper.tMax = 150; %max simulation time [seconds]
params.JansenRitConnectomePaper.dt = {0.001, 0.0005, 0.0001, 0.00005}; % simulation step size [seconds]
params.JansenRitConnectomePaper.sampling = {1, 2, 10, 20}; % sampling every x steps
