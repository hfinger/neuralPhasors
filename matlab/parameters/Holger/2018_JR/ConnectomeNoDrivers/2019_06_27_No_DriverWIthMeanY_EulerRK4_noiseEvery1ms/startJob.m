...
params.JansenRitConnectomePaper.sampling = {1, 2, 4, 10, 1, 2, 4, 10}; % sampling every x steps
params.JansenRitConnectomePaper.sampleNoiseEvery = params.JansenRitConnectomePaper.sampling; % sampling every x steps
...
params.JansenRitConnectomePaper.use_rk4 = num2cell([false(1,4) true(1,4)]);
