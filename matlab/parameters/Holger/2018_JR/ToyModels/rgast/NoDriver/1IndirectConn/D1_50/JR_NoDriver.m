...
params.Gridjob.jobname = 'JR_NoDriver_1IndirectConn';
...
params.JansenRitConnectome.k = num2cell([0.1,1,10]); %global connection strength scaling
...
% delay matrix
d13 = 50; % distance between nodes at the ends of chain
d_ratio = [0:0.01:1];
