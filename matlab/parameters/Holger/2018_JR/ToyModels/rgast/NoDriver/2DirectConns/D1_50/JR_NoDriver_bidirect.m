...
params.Gridjob.jobname = 'JR_NoDriver_bi_re';
...
params.JansenRitConnectome.k = 5; %global connection strength scaling
...
% delay matrix
d1 = 50; % distance between nodes at the ends of chain (first path)
D1 = zeros(2);
D1(1,2) = d1;
D1(2,1) = d1;
...
params.JansenRitConnectome.D = {Delays{56}}; % distance matrix
