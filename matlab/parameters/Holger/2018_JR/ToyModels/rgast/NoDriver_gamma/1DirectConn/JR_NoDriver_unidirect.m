...
params.Gridjob.jobname = 'JR_NoDriver_unidirect';
...
params.JansenRitConnectome.k = num2cell([1,10,100]); %global connection strength scaling
...
params.JansenRit.Connectome.plasticity = false;
...
% delay matrix
d12 = [0:200]; % distance between nodes at the ends of chain
D = zeros(2);
