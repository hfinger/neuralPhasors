...
d12 = 0:10:200;
d23 = 0:10:200;
Delays = cell(length(d12),length(d23));
for d12_idx=1:length(d12)
    for d23_idx=1:length(d23)
...
params.JansenRitConnectomePaper.drivScale = 0.25; % 0.25, 0.5 driver strength [mV]
