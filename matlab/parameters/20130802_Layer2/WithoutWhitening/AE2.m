...
params.Gridjob.jobname = 'layer2AE100weights2';
...
params.Autoencoder.outWeightsFolder = 'layer2AE100weights2';
...
params.Autoencoder.beta = {0.01,0.1};         % weight of sparsity penalty term
params.Autoencoder.gamma = 0;        % weight of topographic sparsity penalty term
params.Autoencoder.maskingNoiseFraction = {0,0.4};        % fraction of inputs to set to 0
