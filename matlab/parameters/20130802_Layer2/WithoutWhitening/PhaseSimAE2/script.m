...
params.ApplyWeights.weightsFile = '../temp_layer2AE100weights2/3/forwConnIter120.mat';
...
params.ProbabilisticConn.numExc = {50,100,200,400};
params.ProbabilisticConn.numInh = {50,100,200,400};
...
params.PhaseSimulation.inConnFilename = strcat('layer2Conn/', cellfun(@num2str,num2cell(1:16)','UniformOutput',false), '/weights.mat')';
...
params.PhaseSimulation.weightAll = 2;
params.PhaseSimulation.weightInh = 1;
params.PhaseSimulation.weightExc = 1;
params.PhaseSimulation.saveintervalPhase = 10;
