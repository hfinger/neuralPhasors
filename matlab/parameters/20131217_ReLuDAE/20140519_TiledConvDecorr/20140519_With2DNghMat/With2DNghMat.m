...
params.Autoencoder.nuCovWeightMat = linearDecoderNghMat( [2 2 2 2],[2 2 5 5],[false false true true]);
params.Autoencoder.nuCovWeightMat = 1-params.Autoencoder.nuCovWeightMat;
