...
params.Autoencoder.lambda = {1, 5};    % weight of L2-decay parameter
...
params.Autoencoder.gamma = {0, 1, 5};        % weight of topographic sparsity penalty term
%params.Autoencoder.gammaPvalue = 0.5;
params.Autoencoder.maskingNoiseFraction = {0.25, 0.5};        % fraction of inputs to set to 0
