...
params.Autoencoder.initWGaussian = true;
params.Autoencoder.initWExponent = 3;
...
params.Autoencoder.lambda = {1, 3, 10};    % weight of L2-decay parameter
...
params.Autoencoder.lambdaL1BackScale = 0;    % weight of L1-decay parameter
params.Autoencoder.fixL2WeightBack = true; %if true, also set backScale to 0
params.Autoencoder.fixL2WeightBackPoolPerHiddenNeuron = {false, true};

params.Autoencoder.scaleLambdaL1WithDistExponent = 0;
params.Autoencoder.beta = 0;         % weight of sparsity penalty term
params.Autoencoder.gamma = {0, 10, 30};        % weight of topographic sparsity penalty term
