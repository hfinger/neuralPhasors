...
params.Gridjob.jobname = 'ReLuDAE100weightsContinue';
params.Autoencoder.inActFolder = '../../20130726_Paper/Autoencoder/labelMeWhite';
params.Autoencoder.inActFilenames = 'act.*.mat';
params.Autoencoder.outWeightsFolder = 'ReLuDAE100weightsContinue';
params.Autoencoder.continue = false;

params.Autoencoder.continueBatch = true;
params.Autoencoder.continueBatchInWeightsFolder = 'ReLuDAE100weights';
params.Autoencoder.continueBatchInBackConnFilenames = 'backConn.mat';
params.Autoencoder.continueBatchInForwConnFilenames = 'forwConn.mat';
...
params.Autoencoder.gamma = {0.1, 0.3, 1};        % weight of topographic sparsity penalty term
