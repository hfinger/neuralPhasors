...
params.Gridjob.jobname = 'ReLuDAE100weightsMaskingNoiseActPenaltyPnorm';
...
params.Autoencoder.outWeightsFolder = 'ReLuDAE100weightsMaskingNoiseActPenaltyPnorm';
...
params.Autoencoder.lambdaL1 = {0, 1};    % weight of L1-decay parameter
params.Autoencoder.smoothLambdaL1WithEpsilon = 1e-5;
params.Autoencoder.scaleLambdaL1WithDistExponent = 0;
params.Autoencoder.beta = {0, 1};         % weight of sparsity penalty term
params.Autoencoder.gamma = {0, 1};        % weight of topographic sparsity penalty term
params.Autoencoder.gammaPvalue = 0.1;
