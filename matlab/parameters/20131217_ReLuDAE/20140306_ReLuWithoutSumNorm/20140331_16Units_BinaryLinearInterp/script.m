...
params.Autoencoder.hiddenSize = 16;
...
params.Autoencoder.binaryLinearInterpEMAconst = {0.9, 0.99, 0.999};

params.Autoencoder.saveinterval = 500;
...
params.Autoencoder.lambda = {0, 5};    % weight of L2-decay parameter
