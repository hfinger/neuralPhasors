...
params.Autoencoder.inSamplesDims = [60 60 3 5200]; % [x,y,#features,#samples]
...
params.Autoencoder.lambda = {0, 0.5, 3};    % weight of L2-decay parameter
...
params.Autoencoder.maskingNoiseFraction = {0.25, 0.5, 0.75};        % fraction of inputs to set to 0
...
params.minFuncGrad.learnrate = 3e-3;
