...
params.Autoencoder.hiddenSize = {ceil(100*(1:10).^1/10^1), ceil(100*(1:10).^2/10^2), ceil(100*(1:10).^3/10^3), ceil(100*exp(1:10)/exp(10))};

plot(1:10,cell2mat(params.Autoencoder.hiddenSize'))
legend('1','2','3','4')
