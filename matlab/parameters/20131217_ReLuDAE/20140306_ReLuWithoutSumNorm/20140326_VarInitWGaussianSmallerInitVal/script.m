...
params.Autoencoder.debugOutput = false;
...
params.Autoencoder.forwInitMaxWeight = 0.003;
params.Autoencoder.forwInitScaleDistFcn = [];
params.Autoencoder.backInitMaxWeight = 0.003;
params.Autoencoder.backInitScaleDistFcn = [];
params.Autoencoder.initWGaussian = {false,true};
...
params.Autoencoder.lambda = {0, 0.3};    % weight of L2-decay parameter
