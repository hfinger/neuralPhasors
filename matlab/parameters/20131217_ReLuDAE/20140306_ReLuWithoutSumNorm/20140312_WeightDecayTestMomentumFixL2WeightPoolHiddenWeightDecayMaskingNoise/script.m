...
params.Autoencoder.fixL2WeightBackPoolPerHiddenNeuron = true;
...
params.Autoencoder.maskingNoiseFraction = 0.5;        % fraction of inputs to set to 0
...
params.minFuncGrad.learnrate = {1e-4, 3e-4, 1e-3};
