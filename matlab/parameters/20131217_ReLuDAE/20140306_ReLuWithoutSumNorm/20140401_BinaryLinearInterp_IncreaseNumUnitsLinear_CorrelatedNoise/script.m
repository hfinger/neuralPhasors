...
params.Autoencoder.hiddenSize = round(linspace(10,100,10));
...
params.Autoencoder.gaussianNoiseSigmaInput = {0.25, 0.5, 1, 2};
params.Autoencoder.gaussianNoiseCorrelated = true;

params.Autoencoder.numberOfPatchReloads = 40;
