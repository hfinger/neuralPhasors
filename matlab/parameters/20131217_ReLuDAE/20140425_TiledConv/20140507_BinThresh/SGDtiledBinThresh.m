...
params.Gridjob.jobname = 'SGDtiledBinThresh';
...
params.Autoencoder.outWeightsFolder = 'SGDtiledBinThresh';
...
params.Autoencoder.hiddenLinearBinaryThresholdUnitsFirst = false; %these are not considered when calculating gradients
params.Autoencoder.hiddenSigmoidBinaryThresholdUnitsFirst = true; %these are not considered when calculating gradients
...
params.minFuncGrad.learnrate = {1e-2, 1e-1, 1e-0, 1e1};
