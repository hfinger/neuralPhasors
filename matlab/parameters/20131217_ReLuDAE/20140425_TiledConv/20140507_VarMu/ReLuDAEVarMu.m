...
params.Autoencoder.mu = {1000, 10000};        % weight of modular topographic sparsity penalty term
params.Autoencoder.muPvalue = {0.1, 0.8};        % Psi_mu = mu * ( muFeatureKernel * (muConvKernel * y2.^2) + muEpsilon ) ^ muPvalue
