...
params.Gridjob.jobname = 'ReLuDAELessTiles';
...
params.Autoencoder.outWeightsFolder = 'ReLuDAELessTiles';
...
params.Autoencoder.mu = {0, 5};        % weight of modular topographic sparsity penalty term
params.Autoencoder.muPvalue = 0.5;        % Psi_mu = mu * ( muFeatureKernel * (muConvKernel * y2.^2) + muEpsilon ) ^ muPvalue
params.Autoencoder.muConvKernel = ones(3,3);
