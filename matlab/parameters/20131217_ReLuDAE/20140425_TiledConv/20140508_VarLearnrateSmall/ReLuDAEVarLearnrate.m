...
params.Gridjob.jobname = 'ReLuDAEVarL';
...
params.Autoencoder.outWeightsFolder = 'ReLuDAEVarL';
...
params.Autoencoder.mu = {1000, 100000};        % weight of modular topographic sparsity penalty term
...
params.minFuncGrad.learnrate = {1e-2,3e-2,1e-1};
