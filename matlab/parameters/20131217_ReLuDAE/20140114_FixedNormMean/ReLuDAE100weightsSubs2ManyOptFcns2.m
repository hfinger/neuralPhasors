...
params.Gridjob.jobname = 'ReLuDAE100weightsSubs2ManyOptFcns2';
...
params.Autoencoder.outWeightsFolder = 'ReLuDAE100weightsSubs2ManyOptFcns2';
...
params.Autoencoder.gamma = {1, 5};        % weight of topographic sparsity penalty term
params.Autoencoder.gammaPvalue = {0.01, 0.1};
