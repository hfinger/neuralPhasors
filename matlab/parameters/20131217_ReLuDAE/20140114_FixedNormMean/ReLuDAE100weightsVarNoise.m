...
params.Gridjob.jobname = 'ReLuDAE100weightsVarNoise';
...
params.Autoencoder.outWeightsFolder = 'ReLuDAE100weightsVarNoise';
...
params.Autoencoder.maskingNoiseFraction = {0, 0.25, 0.5};        % fraction of inputs to set to 0
params.Autoencoder.gaussianNoiseSigmaInput = {0, 0.5, 1};
