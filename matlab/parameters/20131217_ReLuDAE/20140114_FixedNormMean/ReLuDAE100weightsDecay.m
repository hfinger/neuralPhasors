...
params.Gridjob.jobname = 'ReLuDAE100weightsDecay';
...
params.Autoencoder.outWeightsFolder = 'ReLuDAE100weightsDecay';
...
params.Autoencoder.lambda = {0.1, 0.3};    % weight of L2-decay parameter
