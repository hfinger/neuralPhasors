...
params.Gridjob.jobname = 'ReLuDAE100weightsSubs2SparseAct';
...
params.Autoencoder.outWeightsFolder = 'ReLuDAE100weightsSubs2SparseAct';
...
params.Autoencoder.gamma = {0.03, 0.1, 0.3, 1};        % weight of topographic sparsity penalty term
...
params.Gridjob.jobname = 'ReLuDAE100weightsSubs2SparseActWithoutActivationFunction';
...
params.ApplyWeights.outActFolder = 'ReLuDAE100weightsSubs2SparseActWithoutActivationFunction';
params.ApplyWeights.weightsFile = cellfun(@(x) ['ReLuDAE100weightsSubs2SparseAct/' num2str(x) '/forwConn.mat'],num2cell(1:4),'UniformOutput',false);
...
params.Gridjob.runLocal = true;
params.Gridjob.requiremf = 12000;
params.Gridjob.jobname = 'ReLuDAE100weightsSubs2SparseActWithActivationFunction';
params.ApplyWeights.plotPdf = true;
params.ApplyWeights.inActFolder = '../20131220_MoreImages/labelMeWhite/05june05_static_street_boston/p1010736.jpg';
params.ApplyWeights.inActFilenames = 'act.*.mat';
params.ApplyWeights.fileid = 1;
params.ApplyWeights.outActFolder = 'ReLuDAE100weightsSubs2SparseActWithActivationFunction';
params.ApplyWeights.weightsFile = cellfun(@(x) ['ReLuDAE100weightsSubs2SparseAct/' num2str(x) '/forwConn.mat'],num2cell(1:4),'UniformOutput',false);
params.ApplyWeights.convType = 'same';
paramsAll{3} = params;
