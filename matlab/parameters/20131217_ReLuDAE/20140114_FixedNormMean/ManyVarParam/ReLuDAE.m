...
params.Autoencoder.beta = {0, 0.1, 0.3};         % weight of sparsity penalty term
params.Autoencoder.gamma = {0, 10};        % weight of topographic sparsity penalty term
params.Autoencoder.gammaPvalue = 0.01;
