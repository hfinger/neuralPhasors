...
params.ActPhaseCombine.inPhaseFolder = '../../20130726_Paper/Autoencoder/img50PhaseManySamplesFDR0p05maxdx32SmallDt';
params.ActPhaseCombine.inPhaseFilenames = 'phaseIter30.mat';
params.ActPhaseCombine.fileid = num2cell(1:50);
params.ActPhaseCombine.outActFolder = 'layer1ActPhaseCombined';
paramsAll{1} = params;
...
params.Gridjob.wc_host = '';
params.ApplyWeights.inActFolder = 'layer1ActPhaseCombined';
params.ApplyWeights.inActFilenames = 'act1.mat';
params.ApplyWeights.fileid = [];
params.ApplyWeights.outActFolder = 'layer2InitPhaseAfterWhitening';
params.ApplyWeights.weightsFile = '../NoPhaseFromLayer1/layer1ActRectifiedWhiteningWeights/weights.mat';
params.ApplyWeights.inputSubtract = []; % no mean normalizsation for phase propagation
...
params.ApplyWeights.inActFolder = 'layer2InitPhaseAfterWhitening';
params.ApplyWeights.inActFilenames = 'act.*.mat';
params.ApplyWeights.fileid = [];
params.ApplyWeights.outActFolder = 'layer2InitPhaseAfterAE';
params.ApplyWeights.weightsFile = '../NoPhaseFromLayer1/layer2AE100weights/2/forwConn.mat';
params.ApplyWeights.convType = 'same';
params.ApplyWeights.b = []; %delete AE bias for phase propagation
params.ApplyWeights.actFcn = []; %delete AE activation function for phase propagation
paramsAll{3} = params;

clear params;
params.Gridjob.runLocal = false;
params.Gridjob.requiremf = 3000;
params.Gridjob.jobname = 'layer2InitPhaseAfterSplit';
params.Gridjob.wc_host = '';
params.ActPhaseSplit.inActPhaseFolder = 'layer2InitPhaseAfterAE';
params.ActPhaseSplit.inActPhaseFilenames = 'act1.mat';
params.ActPhaseSplit.fileid = [];
params.ActPhaseSplit.outActFolder = []; % don't save act
params.ActPhaseSplit.outPhaseFolder = 'layer2InitPhaseAfterSplit';
paramsAll{4} = params;
...
params.PhaseSimulation.inPhaseFolder = 'layer2InitPhaseAfterSplit';
params.PhaseSimulation.inPhaseFilenames = 'act.*.mat';
