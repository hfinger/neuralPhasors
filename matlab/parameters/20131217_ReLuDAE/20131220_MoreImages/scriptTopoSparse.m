...
params.Gridjob.jobname = 'ReLuDAE100TopoSparse';
...
params.Autoencoder.outWeightsFolder = 'ReLuDAE100TopoSparse';
...
params.Autoencoder.gamma = {0.03, 0.1, 0.3};        % weight of topographic sparsity penalty term
params.Autoencoder.maskingNoiseFraction = 0;        % fraction of inputs to set to 0
params.Autoencoder.gaussianNoiseSigmaInput = 1;
