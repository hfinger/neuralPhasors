...
params.Autoencoder.useRectifiedLinear = true; %instead of sigmoid
...
params.Autoencoder.binaryLinearInterpEMAconst = 0.99;
...
params.Autoencoder.maskingNoiseFractionHidden = {0, 0.25, 0.5, 0.75};        % fraction of inputs to set to 0
params.Autoencoder.maskingNoiseFractionHiddenRescale = true;        % if inputs are rescaled to the variance before masking
