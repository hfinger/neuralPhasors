...
params.ApplyWeights.inActFolder = '../20130318_AE400/labelMeWhite';
...
params.Gridjob.jobname = 'lMLayer1Phase2';
...
params.PhaseSimulation.outPhaseFolder = 'labelMeLayer1Phase2';
...
params.PhaseSimulation.weightAll = {0.1,0.3,1,3};
