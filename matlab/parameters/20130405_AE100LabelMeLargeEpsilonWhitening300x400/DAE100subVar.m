...
params.Gridjob.jobname = 'DAE100SubVar';

params.Autoencoder.inActFolder = '../20130318_AE400/labelMeWhite';
params.Autoencoder.inActFilenames = 'act.*.mat';
params.Autoencoder.outWeightsFolder = 'DAE100SubVarWeights';
...
params.Autoencoder.sparsityParam = {0.01, 0.035};
...
params.Autoencoder.maskingNoiseFraction = {0.2, 0.35};        % fraction of inputs to set to 0
