...
params.Gridjob.jobname = 'inputImages';
params.Gridjob.requiremf = 5000;
params.Gridjob.wc_host = [];
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '6';
params.Load3Ddataset.outActFolder = 'inputImages';
paramsAll{1} = params;

clear params;
params.Gridjob.runLocal = false;
params.Gridjob.jobname = 'whiteningWeights';
params.Gridjob.requiremf = 13000;
params.Gridjob.wc_host = [];
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '7';
params.Whitening.inActFolder = 'inputImages';
params.Whitening.inActFilenames = '.*.mat';
params.Whitening.outWeightsFolder = 'whiteningWeights';
...
params.Gridjob.runLocal = false;
params.Gridjob.requiremf = 13000;
params.Gridjob.jobname = 'inputWhite';
params.Gridjob.wc_host = [];
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '7';
params.ApplyWeights.inActFolder = 'inputImages';
params.ApplyWeights.inActFilenames = '.*.mat';
params.ApplyWeights.fileid = [];
params.ApplyWeights.outActFolder = 'inputWhite';
params.ApplyWeights.weightsFile = 'whiteningWeights/weights.mat';
...
params.Autoencoder.inActFolder = 'inputWhite';
params.Autoencoder.inActFilenames = '.*.mat';
params.Autoencoder.outWeightsFolder = 'ReLuDAE_weights';
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '7';
params.ApplyWeights.inActFolder = 'inputWhite';
params.ApplyWeights.inActFilenames = '.*.mat';
params.ApplyWeights.fileid = [];
params.ApplyWeights.outActFolder = 'layer1Act';
params.ApplyWeights.weightsFile = 'ReLuDAE_weights/forwConn.mat';
params.ApplyWeights.convType = 'same';
params.ApplyWeights.shiftOutputdims = true;
paramsAll{5} = params;

clear params;
gridjobs = Gridjob(paramsAll(2:5));
start(gridjobs);
