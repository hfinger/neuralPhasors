...
params.LoadImage.filepath = {...
  '/net/store/nbp/phasesim/databases/ArtificialStimuli/circle6.png',...
  '/net/store/nbp/phasesim/databases/ArtificialStimuli/alignedLines.png'};
...
clear params;
gridjobs = Gridjob(paramsAll(1:4));
start(gridjobs);
