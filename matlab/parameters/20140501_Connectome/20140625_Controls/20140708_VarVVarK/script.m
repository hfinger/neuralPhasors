...
params.ConnectomeSim.subjId = {1,2,3,4};
...
params.ConnectomeSim.k=num2cell(2.^(8:15));
params.ConnectomeSim.v=num2cell(2.^(-3:0.5:0));
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:224),'UniformOutput',false);
