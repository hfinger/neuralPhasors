...
params.Gridjob.jobname = 'connEnvDownsampled';
params.Gridjob.initRandStreamWithSeed = 1;
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:182),'UniformOutput',false);
params.ConnectomeEnvelope.downsamplingFactor = 8;
...
params.ConnectomeEnvelope.outFilenames = 'connEnvDownsampled';
...
params.Gridjob.requiremf = 14000;
params.Gridjob.wc_host = [];
params.Gridjob.jobname = 'connEnvDownsampledReduce';
params.Gridjob.continue = false;
...
params.ConnectomeEnvelopeReduce.ConnectomeEnvelopeOut = 'connEnvDownsampled';
params.ConnectomeEnvelopeReduce.eegSubjIds = [1:4 7:10];
params.ConnectomeEnvelopeReduce.outDirectory = 'resultsDownsampled';
paramsAll{2} = params;
