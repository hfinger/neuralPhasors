...
params.ConnectomeSim.homotopic = num2cell(0:500:4000);
...
params.ConnectomeSim.k=800;
params.ConnectomeSim.v=0.35;
params.ConnectomeSim.delay=num2cell(2.^(1.5:0.5:5));
params.ConnectomeSim.t_max=200;
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:72),'UniformOutput',false);
...
params.ConnectomeEnvelope.env_t_end = 200;
...
params.Gridjob.requiremf = 14000;
params.Gridjob.wc_host = [];
params.Gridjob.jobname = 'connEnvReduce';
params.Gridjob.continue = false;
...
params.ConnectomeEnvelopeReduce.ConnectomeEnvelopeOut = 'connEnv';
params.ConnectomeEnvelopeReduce.eegSubjIds = [1:4 7:10];
params.ConnectomeEnvelopeReduce.outDirectory = 'results';
paramsAll{3} = params;
