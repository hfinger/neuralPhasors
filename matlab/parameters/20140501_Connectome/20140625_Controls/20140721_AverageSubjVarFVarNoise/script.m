...
params.ConnectomeSim.f={20, 30, 40, 50, 60, 70};
...
params.ConnectomeSim.sig_n=[0 num2cell(2.^(-3:0.5:1))];
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:60),'UniformOutput',false);
