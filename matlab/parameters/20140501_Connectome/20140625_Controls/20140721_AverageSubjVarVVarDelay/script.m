...
params.ConnectomeSim.v=num2cell(2.^(-2:0.5:3));
params.ConnectomeSim.delay=[0, num2cell(2.^(-2:0.5:3))]; %typically 0.3-0.5 ms up to 2 ms
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:132),'UniformOutput',false);
