...
params.ConnectomeSim.k = num2cell([0.05:0.05:0.95 0.999]);
...
params.Gridjob.requiremf = 5000;
params.Gridjob.wc_host = '!ramsauer.ikw.uni-osnabrueck.de';
params.Gridjob.jobname = 'CompareWithEEG_withLPC';
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '6';
params.Gridjob.combParallel = true;
...
params.ConnectomeEnvelopeReduce.outDirectory = 'CompareWithEEG_withLPC';
