...
params.ConnectomeSim.normByDirectionInSimulation = 1;
params.ConnectomeSim.normRowBeforeHomotopic = 0;
params.ConnectomeSim.homotopicFraction = num2cell(0:0.02:0.22);
...
params.ConnectomeSim.k = num2cell(1e-5*(0.25:0.25:25));
