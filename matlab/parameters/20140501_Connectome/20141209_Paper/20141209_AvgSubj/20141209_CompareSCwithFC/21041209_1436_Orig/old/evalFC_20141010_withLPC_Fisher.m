...
params.Gridjob.jobname = 'CompareWithEEG_onlyMatchWithAicohcoh_Fisher';
...
params.ConnectomeEnvelopeReduce.calcFisher = true;
...
params.ConnectomeEnvelopeReduce.outDirectory = 'CompareWithEEG_onlyMatchWithAicohcoh_Fisher';
