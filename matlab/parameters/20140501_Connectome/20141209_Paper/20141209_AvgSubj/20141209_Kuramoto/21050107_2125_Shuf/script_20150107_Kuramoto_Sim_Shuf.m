...
params.Gridjob.runOnlyJobIds = [83]; % 212 229 230 236 237];
...
params.ConnectomeSim.homotopic = num2cell(0:0.03:0.15);
...
params.ConnectomeSim.k=num2cell(200:100:800);
params.ConnectomeSim.v=num2cell(1:0.5:3);
params.ConnectomeSim.delay={0, 0.75, 1.5}; %typically 0.3-0.5 ms up to 2 ms
...
params.ConnectomeEnvelopeReduce.sim.homotopic.Ids = [];%2;
...
params.Gridjob.requiredThreads = '6';
params.Gridjob.combParallel = true;
params.Gridjob.runOnlyJobIds = 1;
