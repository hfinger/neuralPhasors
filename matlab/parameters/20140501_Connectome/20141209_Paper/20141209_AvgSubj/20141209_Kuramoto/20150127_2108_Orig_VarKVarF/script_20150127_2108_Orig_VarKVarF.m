...
params.ConnectomeSim.f=num2cell(20:20:240);
...
params.ConnectomeSim.k=num2cell(300:200:2500);
...
params.ConnectomeEnvelopeReduce.ConnectomeSimOut = 'ConnectomeSim';
params.ConnectomeEnvelopeReduce.ConnectomeEnvelopeOut = 'ConnectomeEnvelope';
params.ConnectomeEnvelopeReduce.eegDatabase = {24, 25, 27};
...
clear params;
gridjobs = Gridjob(paramsAll(1:5));
start(gridjobs);
