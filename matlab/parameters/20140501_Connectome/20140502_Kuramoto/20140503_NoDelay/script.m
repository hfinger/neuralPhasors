...
params.Gridjob.initRandStreamWithSeed = 12345;
params.Gridjob.continue = false;
params.ConnectomeFCeval.inFileRates = {'connRate/1.mat','connRate/2.mat','connRate/3.mat','connRate/4.mat','connRate/5.mat','connRate/6.mat','connRate/7.mat','connRate/8.mat'};
