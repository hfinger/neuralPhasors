...
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['connRate/' num2str(x) 'SimResult.mat'], num2cell(1:4),'UniformOutput',false);
params.ConnectomeEnvelope.source_t_start = -Inf;
params.ConnectomeEnvelope.source_t_end = Inf;
params.ConnectomeEnvelope.saveSamples_t_start = 1:120:1200;
params.ConnectomeEnvelope.saveSamples_t_end = 3:120:1200;
params.ConnectomeEnvelope.env_t_start = [20, 20, 600, 1000];
params.ConnectomeEnvelope.env_t_end = [1200, 600, 1200, 1200];
