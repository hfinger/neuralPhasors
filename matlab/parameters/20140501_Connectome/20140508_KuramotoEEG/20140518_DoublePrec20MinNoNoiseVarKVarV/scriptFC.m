...
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:16),'UniformOutput',false);
...
params.ConnectomeEnvelope.env_t_start = [20 20:60:440];
params.ConnectomeEnvelope.env_t_end = [500 80:60:500];
