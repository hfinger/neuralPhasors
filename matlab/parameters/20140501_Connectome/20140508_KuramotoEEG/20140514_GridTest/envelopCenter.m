...
params.Gridjob.jobname = 'connEnvCenter';
params.Gridjob.initRandStreamWithSeed = 1;
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '1';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['connRate/' num2str(x) 'SimResult.mat'], num2cell(1:8),'UniformOutput',false);
params.ConnectomeEnvelope.source_t_start = 140;
params.ConnectomeEnvelope.source_t_end = 260;
params.ConnectomeEnvelope.env_t_start = 10;
params.ConnectomeEnvelope.env_t_end = 110;
...
params.ConnectomeEnvelope.outFilenames = 'connEnvCenter';
