...
params.Gridjob.jobname = 'connEnvEnd';
...
params.ConnectomeEnvelope.source_t_start = 340;
params.ConnectomeEnvelope.source_t_end = 460;
...
params.ConnectomeEnvelope.outFilenames = 'connEnvEnd';
