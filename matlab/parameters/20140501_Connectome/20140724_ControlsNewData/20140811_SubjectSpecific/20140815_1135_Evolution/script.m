...
paramsAllRange(1).params.ConnectomeSim.k = [200 1400 false true];
paramsAllRange(1).params.ConnectomeSim.v = [0.3 14 false true];
paramsAllRange(1).params.ConnectomeSim.delay = [0 20 false true];
paramsAllRange(1).params.ConnectomeSim.homotopic = [0 0.5 false true];
...
params.Evolution.startGenId = 10;
params.Evolution.initFromOneIndividual = false;
