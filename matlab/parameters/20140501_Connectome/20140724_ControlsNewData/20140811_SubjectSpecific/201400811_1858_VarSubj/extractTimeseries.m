...
params.Gridjob.jobname = 'ConnectomeEnvelopeExtract';
params.Gridjob.initRandStreamWithSeed = 1;
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:1),'UniformOutput',false);
params.ConnectomeEnvelope.source_t_start = -Inf;
params.ConnectomeEnvelope.source_t_end = Inf;
params.ConnectomeEnvelope.saveSamples_t_start = 20;
params.ConnectomeEnvelope.saveSamples_t_end = 40;
...
params.ConnectomeEnvelope.outFilenames = 'ConnectomeEnvelopeExtract';
