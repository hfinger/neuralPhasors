...
params.ConnectomeSim.v=num2cell(0.2:0.2:3.6);
params.ConnectomeSim.delay=num2cell(1.4:0.2:2.2); %typically 0.3-0.5 ms up to 2 ms
params.ConnectomeSim.t_max={500,500};
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:180),'UniformOutput',false);
...
params.ConnectomeEnvelopeReduce.eeg{1}.subj.Ids = 1:10;%[1:4 7:10];
...
params.ConnectomeEnvelopeReduce.eeg{2}.subj.Ids = 1:10;%[1:5 8:10];
