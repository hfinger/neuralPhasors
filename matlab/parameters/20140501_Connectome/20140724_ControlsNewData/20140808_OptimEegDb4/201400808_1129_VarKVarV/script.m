...
params.ConnectomeSim.k=num2cell(350:50:650);
params.ConnectomeSim.v=num2cell(1:0.2:2.6);
params.ConnectomeSim.delay=1.8; %typically 0.3-0.5 ms up to 2 ms
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:63),'UniformOutput',false);
