...
params.ConnectomeSim.v=num2cell(1:0.2:2.4);
params.ConnectomeSim.delay=num2cell(0:0.2:3.2); %typically 0.3-0.5 ms up to 2 ms
params.ConnectomeSim.t_max={320,320};
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:272),'UniformOutput',false);
