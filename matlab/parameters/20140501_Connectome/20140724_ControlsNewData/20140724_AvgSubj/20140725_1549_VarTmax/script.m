...
params.ConnectomeSim.t_max={80,80,80,80,80,80,80,80,140,140,140,140,260,260,500};
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:15),'UniformOutput',false);
...
params.ConnectomeEnvelope.env_t_end = {80,80,80,80,80,80,80,80,140,140,140,140,260,260,500};
