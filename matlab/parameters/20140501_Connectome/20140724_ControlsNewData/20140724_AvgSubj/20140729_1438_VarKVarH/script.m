...
params.ConnectomeSim.homotopic = num2cell(0:0.02:0.2);
...
params.ConnectomeSim.k=num2cell(300:50:700);
params.ConnectomeSim.v=1.75;
params.ConnectomeSim.delay=1.6; %typically 0.3-0.5 ms up to 2 ms
