...
params.ConnectomeSim.v=num2cell(1.7:0.05:1.9);
params.ConnectomeSim.delay=num2cell(1.4:0.1:2); %typically 0.3-0.5 ms up to 2 ms
params.ConnectomeSim.t_max=620;
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:35),'UniformOutput',false);
...
params.ConnectomeEnvelope.env_t_end = 620;
