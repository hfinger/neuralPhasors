...
params.ConnectomeSim.k=num2cell(700:100:1700);
params.ConnectomeSim.v=num2cell(3:12);
params.ConnectomeSim.delay=4; %typically 0.3-0.5 ms up to 2 ms
params.ConnectomeSim.t_max=140;
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:110),'UniformOutput',false);
...
params.ConnectomeEnvelope.env_t_end = 140;
...
params.ConnectomeEnvelopeReduce.eegDatabase = {1,2};
