...
params.ConnectomeSim.v=num2cell(2.5:0.25:4);
params.ConnectomeSim.delay=num2cell(3.5:0.25:6); %typically 0.3-0.5 ms up to 2 ms
params.ConnectomeSim.t_max=180;
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:77),'UniformOutput',false);
...
params.ConnectomeEnvelope.env_t_end = 180;
