...
params.ConnectomeSim.k=num2cell(500:50:800);
params.ConnectomeSim.v=num2cell(2:2:12);
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:42),'UniformOutput',false);
...
params.ConnectomeEnvelope.env_t_end = 320;
