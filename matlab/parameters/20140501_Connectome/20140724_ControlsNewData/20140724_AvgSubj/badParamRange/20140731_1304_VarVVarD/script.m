...
params.ConnectomeSim.v=num2cell(12:2:20);
params.ConnectomeSim.delay=num2cell(2:2:12); %typically 0.3-0.5 ms up to 2 ms
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '5';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:30),'UniformOutput',false);
