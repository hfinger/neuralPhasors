...
params.ConnectomeSim.homotopic = 0.1;
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:9),'UniformOutput',false);
...
% 
% params.ConnectomeEnvelopeReduce.eegSubjIds = num2cell([1:4 6:10]);
% params.ConnectomeEnvelopeReduce.eegAvgSubj = false;
% params.ConnectomeEnvelopeReduce.eegDayIds = [1];
% params.ConnectomeEnvelopeReduce.eegDayAvg = true;
% params.ConnectomeEnvelopeReduce.eegPrePostIds = 1;
% params.ConnectomeEnvelopeReduce.eegPrePostAvg = false;
% params.ConnectomeEnvelopeReduce.eegTaskIds = [];
% params.ConnectomeEnvelopeReduce.eegTaskAvg = true;
...
params.ConnectomeEnvelopeReduce.eeg.prepost.Ids = 1;
params.ConnectomeEnvelopeReduce.eeg.prepost.Avg = false;
params.ConnectomeEnvelopeReduce.eeg.task.Ids = [];
params.ConnectomeEnvelopeReduce.eeg.task.Avg = true;
