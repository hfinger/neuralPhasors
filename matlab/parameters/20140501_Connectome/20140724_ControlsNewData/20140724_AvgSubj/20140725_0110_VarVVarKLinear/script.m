...
params.ConnectomeSim.k=num2cell(400:100:1300);
params.ConnectomeSim.v=num2cell(2.^(-1.5:0.5:2.5));
params.ConnectomeSim.delay=0;
...
params.Gridjob.continue = false;
params.Gridjob.requiredThreads = '3';
params.ConnectomeEnvelope.inFileRates = cellfun(@(x) ['ConnectomeSim/' num2str(x) 'SimResult.mat'], num2cell(1:90),'UniformOutput',false);
