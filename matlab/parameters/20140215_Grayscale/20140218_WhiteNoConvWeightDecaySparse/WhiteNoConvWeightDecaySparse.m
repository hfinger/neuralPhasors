...
params.Gridjob.jobname = 'simWhite';
...
params.RBM.inSamplesDims = [14 14 1]; % [x,y,#features]
...
params.RBM.sparseGain = {0, 0.01, 0.1};			% GAIN ON THE LEARNING RATE FOR SPARSITY CONSTRAINTS
params.RBM.momentum = 0.9;			% (DEFAULT) GRADIENT MOMENTUM FOR WEIGHT UPDATES
params.RBM.wPenalty = {0, 0.01, 0.1};			% L2 WEIGHT PENALTY
