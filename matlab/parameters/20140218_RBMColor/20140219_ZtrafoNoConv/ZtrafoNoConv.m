...
params.RBM.lRate = {0.0001, 0.0003, 0.001};			% LEARNING RATE
params.RBM.nGibbs = 1;				% # OF GIBBS SAMPLES (CONTRASTIVE DIVERGENCE)

params.RBM.sparsity = {0.02, 0.1};		% TARGET HIDDEN UNIT SPARSITY
params.RBM.sparseGain = 0.1;			% GAIN ON THE LEARNING RATE FOR SPARSITY CONSTRAINTS
params.RBM.momentum = 0.9;			% (DEFAULT) GRADIENT MOMENTUM FOR WEIGHT UPDATES
params.RBM.wPenalty = 0.005;%.05;			% L2 WEIGHT PENALTY
