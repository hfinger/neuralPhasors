...
params.GridToyKuramoto.network.k_intraCluster = {0.8,0.9,1};
params.GridToyKuramoto.network.delay_intraClust = {2,3,4}; %in ms
params.GridToyKuramoto.network.numCluster = 3;
params.GridToyKuramoto.network.k_interCluster = {0.1,0.2,0.3};
params.GridToyKuramoto.network.delay_interClust = {4,6,8}; %in ms

params.GridToyKuramoto.sim.k=12;
params.GridToyKuramoto.sim.f=40;
params.GridToyKuramoto.sim.v=10;
params.GridToyKuramoto.sim.t_max=20;
