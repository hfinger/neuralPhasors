...
params.Gridjob.jobname = 'img50PhaseFDR0p01maxdx32';
...
params.PhaseSimulation.outPhaseFolder = 'img50PhaseFDR0p01maxdx32';
...
params.PhaseSimulation.weightAll = 20;
...
params.Gridjob.runLocal = false;
params.Gridjob.requiremf = 3000;
params.Gridjob.jobname = 'layer1EvalLargeSeg1150Img50';
...
params.SegmentationEval.inPhaseFolder = 'img50PhaseFDR0p01maxdx32';
params.SegmentationEval.outSegEvalFolder = 'layer1EvalLargeSeg1150Img50';
params.SegmentationEval.catName = '05june05_static_street_boston';
params.SegmentationEval.fileid = [1:50];
params.SegmentationEval.segSizeBinEdges = exp(5:10);
params.SegmentationEval.minPixelPerSeg = 148;
