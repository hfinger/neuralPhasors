...
params.Gridjob.jobname = 'layer1ConnVarExcInh2manySamples';
params.Gridjob.requiremf = 3000;
params.Gridjob.wc_host = '';
params.ProbabilisticConn.inCorrFile = 'layer1CovManySamples/patchCorr.mat';
params.ProbabilisticConn.outWeightsFolder = 'layer1ConnVarExcInh2manySamples';
...
params.Gridjob.runLocal = false;
params.Gridjob.requiremf = 3000;
params.Gridjob.jobname = 'layer1PhaseVarExcInh2manySamples';
params.Gridjob.wc_host = '';
...
params.PhaseSimulation.inConnFilename = strcat('layer1ConnVarExcInh2manySamples/', cellfun(@num2str,num2cell(1:49)','UniformOutput',false), '/weights.mat')';
params.PhaseSimulation.inPhaseFilename = [];
params.PhaseSimulation.outPhaseFolder = 'layer1PhaseVarExcInh2manySamples';
